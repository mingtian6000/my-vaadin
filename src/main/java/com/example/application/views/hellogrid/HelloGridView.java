package com.example.application.views.hellogrid;
...
@PageTitle("HelloGrid")
@Route(value = "helloGrid", layout = MainLayout.class)
@RouteAlias(value = "", layout = MainLayout.class)
@Uses(Icon.class)
public class HelloGridView extends Div {
    ...
    public HelloGridView(SamplePersonService SamplePersonService) {
        this.samplePersonService = SamplePersonService;
        setSizeFull();
        addClassNames("hello-grid-view");
